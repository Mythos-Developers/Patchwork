...
public class Stasis extends PatchworkEnchantment {
	...
	public Stasis() {
		super(PatchworkRarity.LEGENDARY, Rarity.RARE, EnchantmentTarget.WEAPON, EnchantmentType.hand(), 6, 4);
	}
	...
	public static void registerEnchantment() {
		Registry.register(Registry.ENCHANTMENT, new Identifier(Patchwork.ID, "stasis"), new Stasis());
	}
